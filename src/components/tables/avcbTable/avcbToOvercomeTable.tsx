...
export default function AvcbToOvercomeTable() {
  // ------------ States -----------------
  ...
  const fetchData = useCallback(async () => {
    ...
    const url = `${process.env.NEXT_PUBLIC_BASEURL}/avcbToOvercome`;
  ...
  const dataTable = {
    nodes: data.nodes.filter((item: AvcbToOvercomeType) =>
          ...
          <>
            <Header>
              <HeaderRow>
                ...
                <HeaderCell resize={resize}>E-mail</HeaderCell>
                <HeaderCell resize={resize}>Observações</HeaderCell>
              </HeaderRow>
            </Header>
            <Body>
              {tableList.map((item: AvcbToOvercomeType) => (
